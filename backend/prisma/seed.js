...
async function main() {
  ...
  const results = [
    { courseId: createdCourses[0].id, caScore: 25, examScore: 65, totalScore: 90 },
    { courseId: createdCourses[1].id, caScore: 20, examScore: 55, totalScore: 75 },
    { courseId: createdCourses[2].id, caScore: 18, examScore: 45, totalScore: 63 }
  ];
